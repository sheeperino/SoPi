...
# endif
        ...
        //--------------------------------------------------------------------------------------
        GuiLabel((Rectangle){ state->windowBounds.x + 8, state->windowBounds.y + state->windowBounds.height - 68, 96, 24 }, "File name:");
        if (GuiTextBox((Rectangle){ state->windowBounds.x + 96, state->windowBounds.y + state->windowBounds.height - 68, state->windowBounds.width - 184 - 24, 24 }, state->fileNameText, 128, state->fileNameEditMode))
        {
        ...
        GuiLabel((Rectangle){ state->windowBounds.x + 8, state->windowBounds.y + state->windowBounds.height - 24 - 12, 96, 24 }, "File filter:");
